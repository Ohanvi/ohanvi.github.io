...
description: Recharge your Ohanvi credits with Razorpay using card, UPI, netbanking or a wallet, see the GST before you pay, and apply a coupon code.
---
...
- You are using Ohanvi in a web browser at [app.ohanvi.com](https://app.ohanvi.com). Payment does not work in the Ohanvi mobile app yet.
...
2. Click **Recharge** at the top of the page, or **Recharge credits** in the **This cycle** card. The **Recharge credits** window opens.
    ...
    ![Recharge credits window with quick amounts and Razorpay](assets/screenshots/add-funds-1-recharge-dialog.png)
...
5. Check the breakdown before you pay:
    ...
    This example is for a business in the same state as Ohanvi, or one that has not added a GSTIN. If the GSTIN in your **Invoice Details** is from a different state, you see one **IGST (18%)** line (₹90.00 on ₹500) instead of CGST and SGST. The total is the same.

    ![Recharge window with ₹500 selected and the GST breakdown](assets/screenshots/add-funds-2-amount-500.png)

6. Under **Choose a payment method**, keep **Razorpay** selected.
7. Click **Pay ₹[total]**, where the total is the **You will be charged** figure (for example **Pay ₹590.00** for a ₹500 recharge). Then complete the payment in the Razorpay window.
...
| **Online payment is only available on the web app right now.** | You tried to pay from the Ohanvi mobile app. | Open [app.ohanvi.com](https://app.ohanvi.com) in a browser and recharge from there. |
...
![Custom amount of ₹100 showing Minimum recharge is ₹500](assets/screenshots/add-funds-3-minimum-error.png)
