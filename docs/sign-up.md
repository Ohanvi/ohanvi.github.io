---
title: Sign up for Ohanvi
description: Create an Ohanvi account as an individual or an organization, verify your email with a one-time code, and land on your workspace.
---
...
2. Below the login form, click **Create an Account**.
    ...
    ![Ohanvi login page with the Create an Account link at the bottom](assets/screenshots/sign-up-1-login-page.png)
...
3. Under **Account type**, pick one:
    ...
    ![Sign-up form with Organization selected, showing the organization name field](assets/screenshots/sign-up-3-organization.png)
...
8. If someone gave you a referral code, click **Have a referral code?** and enter it.
    ...
    ![Completed sign-up form with every check shown in green](assets/screenshots/sign-up-4-form-filled.png)
...
11. Type the code in the box and click **Verify**. The code works for 10 minutes.
    ...
    ![Verify your email screen with the 6-digit code box](assets/screenshots/sign-up-5-verify-email.png)
...
12. Your account is created and you are signed in. Ohanvi opens **Connect WhatsApp**, the first setup step for your workspace.
    ...
    ![Connect WhatsApp screen shown right after sign-up](assets/screenshots/sign-up-6-connect-whatsapp.png)
