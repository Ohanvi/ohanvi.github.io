---
title: Sign in to Ohanvi
description: Sign in to your Ohanvi workspace with your username and password, with Google, or with a one-time code sent to your email, and sign out when you are done.
---
...
3. In **Enter your password**, type your password. Click the eye icon to show or hide it.
    ...
    ![Ohanvi login form with username and password filled in](assets/screenshots/sign-in-1-form-filled.png)

4. Click **Log In**. Ohanvi opens **Home**.

    ![Home page after signing in, with the Set up in 5 steps checklist](assets/screenshots/sign-in-2-home.png)
...
1. On the login page, click **Login with email code**.
2. Enter the email linked to your account and request the code.
...
2. Click **Sign out**. The message **Logged out successfully** appears and the login page opens.
    ...
    ![Profile menu with Settings, Current usage and Sign out](assets/screenshots/sign-in-3-profile-menu.png)
